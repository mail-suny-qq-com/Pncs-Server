...
public final class ExecutableExample
{
 ...
 /*   final String connectionUrl =
    ...
    final String connectionUrl =
      "jdbc:mysql://127.0.0.1:3306/sshs?serverTimezone=UTC&characterEncoding=utf8&useUnicode=true&useSSL=false";
    final DatabaseConnectionSource dataSource =
      new DatabaseConnectionSource(connectionUrl);
    ...
    throws Exception
  {
    ...
    final SchemaCrawlerOptionsBuilder optionsBuilder =
      SchemaCrawlerOptionsBuilder.builder()
        ...
        .includeSchemas(new RegularExpressionInclusionRule("SSHS"));
