...
public enum DataTypeEnum {
    ...
    /** oracle */
    ORACLE("oracle", "oracle", "oracle.jdbc.driver.OracleDriver", "\"", "\"", "\"", "\"", "select 1 from dual"),
    ...
    /** hive */
    HIVE2("hive2", "hive2", "org.apache.hive.jdbc.HiveDriver", "", "", "'", "'","SELECT 1 FROM system.dual"),

    /** hive */
    POSTGRESQL("postgresql", "postgresql", "org.postgresql.Driver", "", "", "'", "'","select 1 ");
    ...
    DataTypeEnum(String feature, String desc, String driver, String keywordPrefix, String keywordSuffix, String aliasPrefix, String aliasSuffix,String validationQuery) {
