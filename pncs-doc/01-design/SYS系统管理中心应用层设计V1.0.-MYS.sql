...
DEL_FLAG  DECIMAL(1) COMMENT '删除状态',
CREATE_BY  VARCHAR(32) COMMENT '创建人',
CREATE_TIME  TIMESTAMP COMMENT '创建时间',
UPDATE_BY  VARCHAR(32) COMMENT '更新人',
UPDATE_TIME  TIMESTAMP COMMENT '更新时间',
TYPE  DECIMAL(1) COMMENT '字典类型0为string,1为number',
CRT_USER_CODE  VARCHAR(32) COMMENT '创建人',
CRT_ORG_CODE  VARCHAR(32) COMMENT '创建机构',
CRT_DATE  TIMESTAMP COMMENT '创建日期',
UPD_USER_CODE  VARCHAR(32) COMMENT '修改人',
...
FORM_SHOW  CHAR(1) COMMENT '表单显示',
FORM_TYPE  VARCHAR(255) COMMENT '表单类型',
KEY_TYPE  VARCHAR(255) COMMENT '主键类型',
LIST_SHOW  CHAR(1) COMMENT '列表显示',
NOT_NULL  CHAR(1) COMMENT '非空',
QUERY_TYPE  VARCHAR(255) COMMENT '查询类型',
REMARK  VARCHAR(255) COMMENT '备注',
DATE_ANNOTATION  VARCHAR(255) COMMENT '日期注解',
CRT_USER_CODE  VARCHAR(32) COMMENT '创建用户',
CRT_ORG_CODE  VARCHAR(32) COMMENT '创建机构',
CRT_DATE  TIMESTAMP COMMENT '创建时间',
UPD_USER_CODE  VARCHAR(32) COMMENT '修改用户',
...
ID  VARCHAR(32) NOT NULL  COMMENT '主键',
BAEN_NAME  VARCHAR(255) COMMENT '类名',
CREATE_TIME  TIMESTAMP COMMENT '创建时间',
CRON_EXPRESSION  VARCHAR(255) COMMENT '定时任务表达式',
EXCEPTION_DETAIL  TEXT COMMENT '异常信息',
IS_SUCCESS  CHAR(1) COMMENT '成功标志',
JOB_NAME  VARCHAR(255) COMMENT '任务名称',
METHOD_NAME  VARCHAR(255) COMMENT '方法名',
PARAMS  VARCHAR(255) COMMENT '参数',
TIME  DECIMAL(19,0) COMMENT '时间',
CRT_USER_CODE  VARCHAR(32) COMMENT '创建用户',
CRT_ORG_CODE  VARCHAR(32) COMMENT '创建机构',
CRT_DATE  TIMESTAMP COMMENT '创建时间',
UPD_USER_CODE  VARCHAR(32) COMMENT '修改用户',
