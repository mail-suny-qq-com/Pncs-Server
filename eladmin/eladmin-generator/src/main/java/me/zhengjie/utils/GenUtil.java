...
public class GenUtil {
    ...
    private static Map<String, Object> getGenMap(List<ColumnInfo> columnInfos, GenConfig genConfig) {
        ...
        // 表名
        genMap.put("remark", genConfig.getRemark());
        ...
        for (ColumnInfo column : columnInfos) {
            ...
            // 字段描述
            listMap.put("remark", StrUtil.isEmpty(column.getRemark()) ? "" : column.getRemark());
            // 字段类型
            listMap.put("columnKey", StrUtil.isEmpty(column.getKeyType()) ? "" : column.getKeyType());
            // 主键类型
